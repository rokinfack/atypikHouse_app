<template>
  <div class="form-page-content h-screen">
    <div class="form-auth-card">
      <div class="form-card">
        <form class="mx-14" @submit.prevent="submitForm">
          <div class="form-head">
          ...
          <div class="form-groups" :class="{'error':v$.email?.$errors.length > 0}">
...
export default defineComponent({
  ...
  methods: {
    async submitForm() {
      ...
      this.isLoading = true
      await this.authStores.requestPasswordReset({ email: this.email });
