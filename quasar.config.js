    ...
    build: {
      ...
      extendViteConf(viteConf, { isClient, isServer }) {
        viteConf.plugins.push(
          require("vite-plugin-pages").default({
            resolver: "vue",
            onRoutesGenerated: async (routes) => {
              require("vite-plugin-pages-sitemap")({
      ...
      vitePlugins: [
        ...
        [require("vite-ssg"), {
          onFinished() {
            require("vite-ssg-sitemap").default({
        ...
        [require("vite-plugin-pages").default, {
          resolver: "vue",
          onRoutesGenerated: async (routes) => {
            require("vite-plugin-pages-sitemap").default({
              routes,
              hostname: "localhost:2000"
            });
          }
